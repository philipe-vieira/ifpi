...
public class automovel {
	...
	String nomecombus(){
		if(combustivel == 1){
			JOptionPane.showMessageDialog(null, "Movido à gasolina.");
			nomecombus = "gasolina";
		}
		else if(combustivel == 2){
			JOptionPane.showMessageDialog(null, "Movido à alcool.");
			nomecombus = "alcool";
		}
		else if(combustivel == 3){
			JOptionPane.showMessageDialog(null, "Movido à diesel.");
			nomecombus = "diesel";
		}
		else if(combustivel == 4){
			JOptionPane.showMessageDialog(null, "Movido à gás.");
			nomecombus = "gas";
		}
		else {
			JOptionPane.showMessageDialog(null, "combustivel invalido.");
